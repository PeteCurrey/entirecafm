  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/90 backdrop-blur-sm">
      <motion.div
        ...
        className="glass-panel-strong rounded-3xl p-8 max-w-2xl w-full mx-4 border border-[rgba(255,255,255,0.1)]"
      >
        {/* Progress Bar */}
        <div className="mb-8">
        ...
        <AnimatePresence mode="wait">
          ...
          >
            ...
            {/* Description */}
            <p className="text-lg text-[#CED4DA] mb-4 leading-relaxed">
